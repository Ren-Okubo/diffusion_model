...
if __name__ == '__main__':
    ...
    ax_cos_first.plot(x_for_RDF,sorted_by_cos[0][0],label='original')
    ax_cos_first.plot(x_for_RDF,sorted_by_cos[0][1],label='generated')
    ax_cos_first.set_title('best_cos_similarity')
    ax_cos_second.plot(x_for_RDF,sorted_by_cos[1][0],label='original')
    ax_cos_second.plot(x_for_RDF,sorted_by_cos[1][1],label='generated')  
    ax_cos_second.set_title('second_best_cos_similarity')
    ax_cos_third.plot(x_for_RDF,sorted_by_cos[2][0],label='original')
    ax_cos_third.plot(x_for_RDF,sorted_by_cos[2][1],label='generated')
    ...
    ax_cos_worst.plot(x_for_RDF,sorted_by_cos[-1][0],label='original')
    ax_cos_worst.plot(x_for_RDF,sorted_by_cos[-1][1],label='generated')
